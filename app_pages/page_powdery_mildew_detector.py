...
def page_powdery_mildew_detector_body():
    st.info(
        f"* The client is interested in telling whether a given cell contains a powdery mildew "
        f"or not."
    )

    st.write(
        f"* You can download a set of powdery mildew and healthy leaves for live prediction. "
